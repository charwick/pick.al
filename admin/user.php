...
<html lang="en-US">
<head>
	<title>User profile: <?= $user->username; ?> | Pick.al</title>
...
<body class="admin-user">
	...
	<main>
		<a href="http://gravatar.com/" id="gravatar-link" target="_gravatar">
			<img src="https://www.gravatar.com/avatar/<?= md5(strtolower(trim($user->email))); ?>?s=160&d=mp" class="gravatar" />
		</a>
		<h1>
			Profile
		...
		<p>Email: <span id="email"><?= $user->email; ?></span> <span class="actions"><a href="#" class="edit" title="Edit"></a></span></p>
		<p id="password" data-date="<?= $user->password ? date('F j, Y \a\t H:i', strtotime($user->pwchanged)) : 'never'; ?>">
			Password:
			<span class="field" id="oldpw"><?= $user->password ? '••••••••' : 'None'; ?></span><span class="field" id="newpw"></span><span class="field" id="confirm_password"></span>
